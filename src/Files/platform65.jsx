/************************************
* Original File: platform65.html    *
* File Name: platform65.jsx         *
* Translater: Ammar S.A.A           *
************************************/

import React from 'react'

export default function platform65() {
  return (
    <>
  <meta charSet="UTF-8" />
  <meta httpEquiv="X-UA-Compatible" content="IE=edge" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Vantilu | Restaurant</title>
  <link
    rel="icon"
    href="./Images/Restaurants/download.png"
    type="image/icon type"
  />
  <link rel="stylesheet" href="platform65.css" />
  ...
  <section className="home" id="home">
    <div className="barb">
      <h2>
        <img src="./Images/Restaurants/about_platform65.jpg" height={150} />
      </h2>
      <div className="cont">
        <iframe
          width={420}
          height={315}
          src="https://www.youtube.com/embed/k5WvY9CAKu8?autoplay=1&mute=1&loop=1&playlist=k5WvY9CAKu8&loop=1"
        ></iframe>
      </div>
    </div>
  </section>
  <section className="fastfood" id="fast">
    <h2 className="fastfood1">Platform65</h2>
    <hr className="line" />
    <h4>Fast Food</h4>
  ...
  <section className="starters" id="start">
    ...
    <div className="box-starters">
      ...
      <div className="box">
        <img src="./Images/Dishes/chilli-prawns.jpg" />
        <h3>Chilli Prawns</h3>
        <div className="stars">
          <i className="fas fa-star" />
          <i className="fas fa-star" />
      ...
      <div className="box">
        <img src="./Images/Dishes/Ginger-Fish-Dry.jpg" />
        <h3>Ginger Fish</h3>
        <div className="stars">
          <i className="fas fa-star" />
          <i className="fas fa-star" />
      ...
      <div className="box">
        <img src="./Images/Dishes/chilli-egg.jpg" />
        <h3>Chilli Egg</h3>
        <div className="stars">
          <i className="fas fa-star" />
          <i className="fas fa-star" />
      ...
      <div className="box">
        <img src="./Images/Dishes/mushroom65.jpg" />
        <h3>Mushroom 65</h3>
        <div className="stars">
          <i className="fas fa-star" />
          <i className="fas fa-star" />
      ...
      <div className="box">
        <img src="./Images/Dishes/chilli-babycorn.jpg" />
        <h3>Chilli babycorn</h3>
        <div className="stars">
          <i className="fas fa-star" />
          <i className="fas fa-star" />
          <i className="fas fa-star" />
      ...
      <div className="box">
        <img src="./Images/Dishes/baby-corn-manchurian.jpg" />
      ...
      <div className="box">
        <img src="./Images/Dishes/veg-spring-roll.jpg" />
