/********************************
* Original File: Barbeque.html  *
* File Name: Barbeque.jsx       *
...
export const Barbeque = () => (
    <>
      ...
      <section className="home" id="home">
        <div className="barb">
          <h2>
            <img src="./Images/Restaurants/barbeque1.jpg" height={350} />
          </h2>
          <div className="cont">
            <iframe
              width={420}
              height={315}
              src="https://www.youtube.com/embed/gT8Acv6pQTs?autoplay=1&mute=1&loop=1&controls=0&playlist=gT8Acv6pQTs&loop=1"
            ></iframe>
          </div>
        </div>
      </section>
      <section className="currys" id="curry">
        <h2 className="barbeque">Barbeque</h2>
        <hr className="line" />
        <h4>Curry's</h4>
        <div className="box-curry">
          ...
          <div className="box">
            <img src="./Images/Dishes/natukodi.jpg" />
            <h3>Natu Kodi</h3>
            <div className="stars">
              <i className="fas fa-star" />
              <i className="fas fa-star" />
      ...
      <div id="about" className="about">
        ...
        <div className="about-overlay">
          ...
          <p>
            ...
            and write customer generated reviews and view and upload photos,
