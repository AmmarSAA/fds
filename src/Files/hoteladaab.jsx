/************************************
* Original File: hoteladaab.html    *
* File Name: hoteladaab.jsx         *
* Translater: Ammar S.A.A           *
************************************/

import React from 'react'

export default function hoteladaab() {
  return (
    <>
  <meta charSet="UTF-8" />
  <meta httpEquiv="X-UA-Compatible" content="IE=edge" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Adaab | Restaurant</title>
  <link
    rel="icon"
    href="./Images/Restaurants/download.png"
    type="image/icon type"
  />
  <link rel="stylesheet" href="hoteladaab.css" />
  ...
  <section className="home" id="home">
    <div className="barb">
      <h2>
        <img src="./Images/Restaurants/aadab.png" height={150} />
      </h2>
      <div className="cont">
        <iframe
          width={420}
  ...
  <section className="fastfood" id="fast">
    <h2 className="fastfood1">Hotel Adaab</h2>
    <hr className="line" />
    <h4>Fast Food</h4>
  ...
  <section className="currys" id="curry">
    <h2 className="hoteladaab">hotel adaab</h2>
    <hr className="line" />
    <h4>Curry's</h4>
