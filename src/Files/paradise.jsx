/********************************
* Original File: paradise.html  *
* File Name: paradise.jsx       *
...
export default function paradise() {
  ...
  <section className="home" id="home">
    <div className="barb">
      <h2>
        <img src="./Images/Restaurants/paradise-img.jpg" height={150} />
      </h2>
      <div className="cont">
        <iframe
          width={420}
          height={315}
          src="https://www.youtube.com/embed/iYk6EMmYb_Y?autoplay=1&mute=1&loop=1&playlist=iYk6EMmYb_Y&loop=1"
        ></iframe>
      </div>
    </div>
  </section>
  <section className="fastfood" id="fast">
    <h2 className="fastfood1">paradise</h2>
    <hr className="line" />
    <h4>Fast Food</h4>
  ...
  <section className="currys" id="curry">
    <h2 className="paradise">paradise</h2>
    <hr className="line" />
    <h4>Curry's</h4>
