/*****************************
* Original File: mehfil.html *
* File Name: mehfil.jsx      *
...
export default function mehfil() {
  ...
  <section className="home" id="home">
    <div className="barb">
      <h2>
        <img src="./Images/Restaurants/mehfil-logo.jpg" height={150} />
      </h2>
      <div className="cont">
        <iframe
          width={420}
  ...
  <section className="fastfood" id="fast">
    <h2 className="fastfood1">Mehfil</h2>
    <hr className="line" />
    <h4>Fast Food</h4>
